...
const SmallMap = props => {
  ...
  const mediaDarkMode = use_media__WEBPACK_IMPORTED_MODULE_3___default()("(prefers-color-scheme: dark)");
...
/* harmony default export */ __webpack_exports__["default"] = (SmallMap);
